 // ── AUTO-HIDE UI ──────────────────────────────────────────────
        ...
        function onResults(results) {
            ...
            if (results.multiHandLandmarks && results.multiHandLandmarks.length > 0) {
                // First hand detected → instantly hide menu, game is running
        ...
        function restartGame() {
            ...
            showUI();   // show panel so player sees the instructions again
            animate();
        }
